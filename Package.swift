...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ZarliSDKSwift",
            url: "https://github.com/zarli-ai/zarli-ios-sdk/releases/download/1.3.41/ZarliSDKSwift.xcframework.zip",
            checksum: "b42b57a467e8a8ad50df55ce035400fef2a65f2756ff852d525deeb8f6b3cbb1"
        ),
