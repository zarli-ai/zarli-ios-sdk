...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ZarliSDKSwift",
            url: "https://github.com/zarli-ai/zarli-ios-sdk/releases/download/1.3.38/ZarliSDKSwift.xcframework.zip",
            checksum: "f6bb1cead0412627ba0f22683b261f3cb1c9b379002c8cf288dd4dd83f6e4862"
        ),
