...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ZarliSDKSwift",
            url: "https://github.com/zarli-ai/zarli-ios-sdk/releases/download/1.3.32/ZarliSDKSwift.xcframework.zip",
            checksum: "c2b834354422db7d3ba9583f78a09379ce8e52b419b720ab5b02658c6502ab90"
        ),
