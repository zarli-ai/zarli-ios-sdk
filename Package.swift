...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ZarliSDKSwift",
            url: "https://github.com/zarli-ai/zarli-ios-sdk/releases/download/1.3.34/ZarliSDKSwift.xcframework.zip",
            checksum: "b10dc89dfcff8cb423155b0c5d2f14545dfba39d6df79f96681751120bc24d3f"
        ),
