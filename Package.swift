...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ZarliSDKSwift",
            url: "https://github.com/zarli-ai/zarli-ios-sdk/releases/download/1.3.22/ZarliSDKSwift.xcframework.zip",
            checksum: "1e5c33c85137c16019b1b07ae97ebcd99062be96d96901178710a0fb720bc0b8"
        ),
