...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ZarliSDKSwift",
            url: "https://github.com/zarli-ai/zarli-ios-sdk/releases/download/1.3.23/ZarliSDKSwift.xcframework.zip",
            checksum: "1f2ccb2451856a2a7a7f543a290c3c1c5ec28e4c7cc8598080ca305ee598256d"
        ),
