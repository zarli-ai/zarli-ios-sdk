...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ZarliSDKSwift",
            url: "https://github.com/zarli-ai/zarli-ios-sdk/releases/download/1.3.46/ZarliSDKSwift.xcframework.zip",
            checksum: "2e92b2e3008fdcb71a4c28c743c9a963fd6d81dfd3104dbe5e9ae9719a302834"
        ),
