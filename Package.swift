...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ZarliSDKSwift",
            url: "https://github.com/zarli-ai/zarli-ios-sdk/releases/download/1.3.60/ZarliSDKSwift.xcframework.zip",
            checksum: "bd8952b0fcec3235510c581db38e1d3a6eca91de73ac284f40de600f57941ca0"
        ),
