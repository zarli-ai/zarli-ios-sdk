...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ZarliSDKSwift",
            url: "https://github.com/zarli-ai/zarli-ios-sdk/releases/download/1.3.53/ZarliSDKSwift.xcframework.zip",
            checksum: "fe18f3e0e4a0f7370735aeb2d035d049112f1a086c0f991bf85d71f6712e7386"
        ),
