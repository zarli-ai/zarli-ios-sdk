...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ZarliSDKSwift",
            url: "https://github.com/zarli-ai/zarli-ios-sdk/releases/download/1.3.54/ZarliSDKSwift.xcframework.zip",
            checksum: "35d3aec7d93157b0d1aeb12635b8e2db203aa844cbd2aa90a8799bd30987ee51"
        ),
