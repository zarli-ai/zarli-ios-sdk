...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ZarliSDKSwift",
            url: "https://github.com/zarli-ai/zarli-ios-sdk/releases/download/1.3.63/ZarliSDKSwift.xcframework.zip",
            checksum: "403478b86f2980ce70e8060acffa46c1950c919746b39da04bcb39c591973d10"
        ),
