...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ZarliSDKSwift",
            url: "https://github.com/zarli-ai/zarli-ios-sdk/releases/download/1.3.40/ZarliSDKSwift.xcframework.zip",
            checksum: "83a2ed84b2f65214636968947594eac8c154fa0fed5462778e4577145c3a8aae"
        ),
