...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ZarliSDKSwift",
            url: "https://github.com/zarli-ai/zarli-ios-sdk/releases/download/1.3.21/ZarliSDKSwift.xcframework.zip",
            checksum: "2ecd92e433562aedf5a4fae1f77f6424087d8b36c9224d922cf8f67bc2d88c2a"
        ),
