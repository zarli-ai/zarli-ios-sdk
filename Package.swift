...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ZarliSDKSwift",
            url: "https://github.com/zarli-ai/zarli-ios-sdk/releases/download/1.3.50/ZarliSDKSwift.xcframework.zip",
            checksum: "089e82f9b5b471ab0908325a692c68ad956bdefadeef68dc1b7f6b341eac8b89"
        ),
