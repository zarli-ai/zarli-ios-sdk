...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ZarliSDKSwift",
            url: "https://github.com/zarli-ai/zarli-ios-sdk/releases/download/1.3.45/ZarliSDKSwift.xcframework.zip",
            checksum: "b3d4252c2f58cf50548c7d7ae6e7c58a4b581600b159454f13c36f641faabf4b"
        ),
