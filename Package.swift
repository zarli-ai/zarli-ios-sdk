...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ZarliSDKSwift",
            url: "https://github.com/zarli-ai/zarli-ios-sdk/releases/download/1.3.48/ZarliSDKSwift.xcframework.zip",
            checksum: "ebf4c3bea0d4905618b0bfbee13902a399c8394429d8d8ddff5d2f9b814f2862"
        ),
