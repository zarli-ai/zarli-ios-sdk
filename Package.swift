...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ZarliSDKSwift",
            url: "https://github.com/zarli-ai/zarli-ios-sdk/releases/download/1.3.52/ZarliSDKSwift.xcframework.zip",
            checksum: "04273ca3a2ac38438514aceff2b54f5bef537d086122a1cd7506896c13cee709"
        ),
